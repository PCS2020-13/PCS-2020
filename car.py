...
class Car:
    ...
    def drive(self):
        ...
        Arguments:
            new_pos {(int, int)} -- A tuple containing the x and y coordinates of the new position.

        Returns:
            {(int, int)} -- A tuple containing the x and y coordinates of the updated current position.
        """
